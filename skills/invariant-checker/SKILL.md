...
description: Fast specialist that checks whether a piece of work preserves its emotional invariant (WONDER by default, or a stated alternative). Invoke for a quick, focused pass — it identifies the invariant, checks the evidence for and against it, analyzes where it leaks, and returns a Preserved / Lost verdict. Narrower and faster than the full decision engine. Runs as a delegated subagent, not in the main session.
---
